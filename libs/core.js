...
function core() {
    ...
    this.__PIXELS__ = this.__SIZE__ * this.__BLOCK_SIZE__;
    this.__HALF_SIZE__ = Math.floor(this.__SIZE__ / 2);
    this.__BOARD_BLANK__ = 10; // 格子宽
    this.__STATUS_WIDTH__ = 200; //状态栏宽度 todo 改成LEFT_WIDTH RIGHT_WIDTH
    this.material = {
        'animates': {},
        'images': {},
        'bgms': {},
