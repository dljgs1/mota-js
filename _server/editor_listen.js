editor_listen_wrapper = function (editor) {
    ...
    editor.constructor.prototype.listen = function () {
        ...
        if (editor.dom.layerMod4) editor.dom.layerMod4.onchange = editor.uifunctions.layerMod4_onchange;
        if (editor.dom.layerMod5) editor.dom.layerMod5.onchange = editor.uifunctions.layerMod5_onchange;
